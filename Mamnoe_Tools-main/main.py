...
def main():
    ...
    # Set Console title
    set_console_title("Mamnoe Tools V1 | Made by XrayAlive | Menu")
    ...
    banner = """
                        ...
                        ╔═════════════════════════╗         ╔═════════════════════════╗
                        ║     dsc.gg/GM8FWQGA     ║         ║      dsc.gg/GM8FWQGA    ║
                     ╔═══════════════════════════════╗   ╔═══════════════════════════════╗
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by XrayAlive [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
# ========================================================================================================================================================= #
    ...
    if choice == "1":
        ...
        message = "@everyone Closed By Mantaghe Mamnoe | discord.gg/fHz9NDHV"
...
def socials():
    ...
    # Set Console title
    set_console_title("Crypto Tools V1 | Made by XrayAlive | Socials")
